...
>
>
>3.응답시간의 최소화: 응답시간이란 하나의 작업이 컴퓨터 시스템을 이용하여 시작한 시간에서부터결과를 얻을 때까지 소요되는 시간을 가리킨다.
>
>
...
>
>
>작업 관리 프로그램은 사용자가 시스템에게 어떤 작업을 수행하게 지시하는 명령을 해독하여, 그 작업이 수행되게 하고 작업이 끝나면 마무리를 해준다.
>```
>
><br>
><br>
