...
><br>
><br>
>또, try 블럭과 finally 블럭에서 모두 예외가 발생하면, finally 블럭에서 예외가 처리될 때 try 블럭에서의 예외는 무시됩니다.(try문에서의 예제가 먼저 처리되더라도 finally 예외가 발생했을때 try 예외는 잊혀지고 finally 예외만 처리함)
><br>
><br>
...
<br>
다음 장 [[java]20.java.lang패키지](https://kookyungmin.github.io/java/2018/06/11/java_20.html)
